...
\tikzset{
    >=Stealth,
    rectanglenode/.style = {draw, rectangle, rounded corners=0em, inner sep = 2pt},
    ellipsenode/.style = {draw, ellipse, inner sep = 2pt},
    textnode/.style  = {align=center, node distance=0em},
    circlenode/.style = {draw, circle, inner sep = 0em, minimum size=1.5em}, 
    dotnode/.style = {draw, fill=black, circle, minimum size=0.1em, inner sep = 0em},  
    connect/.style = {black,->}, 
