...
\tikzset{
    >=Stealth,
    shapenode/.style = {draw, rectangle, fill=none, minimum size=0.5cm, minimum height=0.6cm, minimum width=0.6cm, align=center, font=\normalsize}, 
    roundnode/.style = {draw, rectangle, rounded corners=0.5em, inner sep=0.5em, align=center},
    textnode/.style  = {draw=none, fill=none, align=center, font=\normalsize},
    circlenode/.style = {draw, circle, minimum size=1.5em, inner sep=0pt, align=center},
    dotnode/.style = {draw, fill=black, circle, minimum size=0.2em, inner sep=0pt},
    connect/.style = {black, ->, line width=0.5pt}
}
