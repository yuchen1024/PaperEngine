...
\tikzset{
    highlight/.style={draw=red, line width=1pt, inner sep=2pt}
    >=Stealth,
    shapenode/.style = {draw, rectangle, fill=none, auto, node distance=0em}, 
    roundnode/.style = {draw, rectangle, rounded corners=0.5em, inner sep = 0em, node distance=0em, minimum height=1.5em},
    ...
    textnode/.style  = {draw=none, fill=none, rectangle, node distance=0em},
