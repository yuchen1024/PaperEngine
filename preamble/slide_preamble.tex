...
% --- Custom TikZ Styles ---
\tikzset{
    rectanglenode/.style = {draw, rectangle, inner sep = 0.2em, node distance=0em, rounded corners=0em},
    circlenode/.style    = {circle, draw, auto, inner sep = 0em, node distance=0em}, 
    textnode/.style    = {node distance=0em}, 
...
\newcommand{\tightfbox}[1]{%
  \mathchoice
    {\setlength{\fboxsep}{0pt}\fbox{$\displaystyle #1$}}
    {\setlength{\fboxsep}{0pt}\fbox{$\textstyle #1$}}
    {\setlength{\fboxsep}{0pt}\fbox{$\scriptstyle #1$}}
    {\setlength{\fboxsep}{0pt}\fbox{$\scriptscriptstyle #1$}}%
}
...
\setbeamercolor{block body}{bg=blue!20,fg=black}\begin{block}{}}{\end{block}}
\newenvironment{remarkblock}[0]{%
\setbeamercolor{block body}{bg=darkgreen!20,fg=black}\begin{block}{}}{\end{block}}
