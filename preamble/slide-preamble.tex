...
\usepackage{array}
\usepackage{multirow}
\usepackage[table]{xcolor} % 可选：用于添加颜色
...
\usepackage{caption}
\usepackage[absolute, overlay]{textpos} % 固定图片位置
...
\usepackage{tikz}     % 绘图包
\usetikzlibrary{calc, matrix, patterns, backgrounds, arrows, arrows.meta, shapes, snakes, circuits, circuits.logic.US, 
...
\definecolor{orchid}{rgb}{0.855, 0.439, 0.839} % RGB values for orchid

% dedicate for PSO
% \definecolor{PSOcolor}{blue!30}
% \definecolor{PMTcolor}{darkgreen!30}
% \definecolor{OTcolor}{purple!30}
% \definecolor{OPRFcolor}{gray!30}
% \definecolor{PEQTcolor}{orange!30}
% \definecolor{MISCcolor}{magenta!30}
...
\newcommand{\lightgrayul}{\bgroup\markoverwith{\textcolor{gray!20}{\rule[-0.5ex]{2pt}{0.4pt}}}\ULon} % 灰色下划线
